...
namespace u_i
{
    class batch
    {
        ...
        public class added
        {
            public added()
            {
                content = new CoroutineReplacement.crValues[size];
                free = new freed[size];
            }

            public CoroutineReplacement.crValues[] content;
            public freed[] free;
        ...
        private static CoroutineReplacement.crValues nullValue = new CoroutineReplacement.crValues()
        {
            enumerator = null
        };
        ...
        public CoroutineHandle Add(CoroutineReplacement.crValues value)
        {
            added access;
            int index;
            if(peakFree >= 0)
        ...
        public ref CoroutineReplacement.crValues GetNext()
        {
            do
            {
    ...
    static class Timing
    {
        ...
        {
            return a.Add(new CoroutineReplacement.crValues()
            {
                remainingTime = 0F,
        ...
        {
            return bins[bin].Add(new CoroutineReplacement.crValues()
            {
                remainingTime = 0F,
                enumerator = coroutine
            });
    ...
    class CoroutineReplacement : MonoBehaviour
    {
